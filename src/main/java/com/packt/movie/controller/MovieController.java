...
MovieImplService movieImplService = null;
	...
	public String helloWorld( @ModelAttribute("movieList")MovieList movieList,ModelMap map ){
		...
		/*movieList1.setMovieDate("Feb10th");
		movieList1.setMovieName("Admiral Yi San");
		movieList1.setMovieDuration("11:00PM");*/
	...
	public String addMovieLink(@ModelAttribute("movieList")MovieList movieList,
		...
		if(movieImage !=null ){		//Multipart
			...
			/*try{
				movieImage.transferTo(new File(rootDirectory+
	...
	public String addNewUser(@ModelAttribute("newUser")@Valid NewUser newUser){
	...
	public String newUser(@ModelAttribute("newUser") @Valid NewUser newUser,BindingResult result){
		if(result.hasErrors()){
			System.out.println("New User ModeAttribute has error"+result.getErrorCount());
